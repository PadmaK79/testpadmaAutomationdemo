...
public class EditOpportunityPopUp {
...
System.setProperty("webdriver.chrome.driver","C:\\Users\\padma.kavitha\\Downloads\\chromedriver_win32\\chromedriver.exe");
      ...
      //Lead Inquiry Date- Select Date
      	...
      	Thread.sleep(2000);
      	driver.findElementByXPath("//span[@class='slds-day weekday nextMonth DESKTOP uiDayInMonthCell--default'][normalize-space()='8']").click();
      	Thread.sleep(2000);
      ...
      //Stage-Select value
      	...
      	Thread.sleep(2000);
      	driver.findElementByXPath("(//a[text()='Sale Pending'])[1]").click();      		
      	Thread.sleep(2000);  		
      ...
      //Community-search
      	...
      	Thread.sleep(5000);
      	driver.findElement(By.xpath("//input[@title='Search Communities']")).sendKeys(Keys.ARROW_DOWN);
        Thread.sleep(3000);
     ...
     //Sale Date - Select Date 
      ...
      //Escrow Status 
      	 ...
      	 Thread.sleep(2000);
      	 driver.findElementByXPath("(//a[text()='Buyer'])[1]").click();
      	 Thread.sleep(2000);
      	 
      //Customer Name
   		 driver.findElementByXPath("(//input[@title=\"Search Accounts\"])[1]").sendKeys("Test Padma");
     	 Thread.sleep(3000);
     	 driver.findElementByXPath("(//input[@title=\"Search Accounts\"])[1]").sendKeys(Keys.ARROW_DOWN);
     	 Thread.sleep(2000);
     	 driver.findElementByXPath("(//input[@title=\"Search Accounts\"])[1]").sendKeys(Keys.ENTER);
     	 Thread.sleep(1000);
      		
      //contingency
      	 driver.findElementByXPath("(//div[@class='uiPopupTrigger'])[5]").click();
      	 Thread.sleep(2000);
      	 driver.findElementByXPath("(//a[text()='Contingency Release'])[1]").click();
      	 Thread.sleep(2000);
      ...
      //Original Inside Sales
   		 driver.findElementByXPath("(//input[@title='Search People'])[2]").sendKeys("Kirsten Smith");
     	 Thread.sleep(3000);
     	 driver.findElementByXPath("(//input[@title='Search People'])[2]").sendKeys(Keys.ARROW_DOWN);
     	 Thread.sleep(2000);
     	 driver.findElementByXPath("(//input[@title='Search People'])[2]").sendKeys(Keys.ENTER);
     	 Thread.sleep(2000);
...
//Registration Card
  		...
  		Thread.sleep(2000);
  		driver.findElementByXPath("//a[text()='Direct Mail']").click();
  		Thread.sleep(2000);
  		...
  		driver.findElementByXPath("(//div[@class='uiPopupTrigger'])[11]").click();
  		Thread.sleep(2000);
  		...
  		WebElement link = driver.findElementByXPath("(//div[@class='slds-dueling-list__options'])[1]/ul/li[2]/div");
  		action.doubleClick(link).perform();
  		Thread.sleep(2000);
  		driver.findElementByXPath("//button[@title='Move selection to Chosen']").click();
  		Thread.sleep(2000);
  		
  		
  		
  		//Ideal date to move-SelectDate
      ...
      //Registration Card 4:2 and Buying Formula
        ...
        //Save button
        	sdriver.findElementByXPath("//button[@title='Save']").click();
